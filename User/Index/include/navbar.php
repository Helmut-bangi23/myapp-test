...
<div class="collapse navbar-collapse" id="collapsibleNavbar">
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-bitem">
  <a href="/E-Commerce/User/Index/viewcart.php" class="btn btn-primary mb-1" style="height: 40px; width: 80px;">
    Cart
  </a>
</li>

<li class="nav-bitem">
  <a href="./Sql/clrcart.php" class="btn btn-danger mb-1" id="nav-btn" style="height: 40px; width: 110px;">
    Clear Cart
  </a>
</li>
...
<li class="nav-bitem d-flex align-items-center">
  ...
  <a href="/E-Commerce/User/index.php" class="ml-2">
