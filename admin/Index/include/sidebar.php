				...
				<div class="das_icon" id="navi">
					<nav>
						<a href="../Index/index.php"
							style="background-color: #081414ff; color: #efeff3ff; margin-right: 14px; border-radius: 5px;"><i
						...
						<a href="#" onclick="show4()"><i class="fas fa-sticky-note" style="margin-right: 16px;"></i> Transactions
                        <i class="fas fa-angle-right" id="drop4"></i></a>
